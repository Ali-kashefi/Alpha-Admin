...
function Header() {
  ...
  return (
    <div>
      <header className="w-full h-20 bg-primary-50  p-4  flex flex-row justify-between">
        ...
        <div className="flex flex-row-reverse gap-4">
          ...
          <SearchBox placeholde="Search or type command..." className="w-96 h-12 rounded-lg border border-primary-300 shadow-md" />
        </div>
      </header>
    </div>
  );
